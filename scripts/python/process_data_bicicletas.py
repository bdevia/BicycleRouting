...
input_geojson_file = "./data/accidentes/accidentes_bicicleta_2022.geojson"
output_geojson_file = "./metadata/accidentes/accidentes.geojson"
...
print(f"archivo GeoJSON: {output_geojson_file}, generado exitosamente")
